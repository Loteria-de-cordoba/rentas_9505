...
$_pagi_sql = "select id_mep, b.descripcion as concepto, quincena, mes, anio, to_char(fechamep,'DD/MM/YYYY') as fecha_deposito, 
					...
					from impuestos.mep9505 a, impuestos.cuenta_deposito b
...
<link href="estilo/estilo.css" rel="stylesheet" type="text/css" />
<br />
<a href="#" onClick="ajax_get('contenido','agregar_detalle_mep.php','');"><img src="image/Plus20.png" width="18" height="18" border="0"/></a>
<a href="#" onClick="ajax_get('contenido','agregar_detalle_mep.php','');">Nuevo</a> 
