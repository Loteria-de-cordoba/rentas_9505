 ...
 *------------------------------------------------------------------------
 */
 if(!isset($_pagi_enlace)){
	// $_pagi_enlace no esta especificada la paginade destino sera $_SERVER['PHP_SELF']
 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='#' onClick=\"ajax_get('".$_pagi_div."','".$_pagi_enlace."','".$_pagi_enlace_var."_pagi_pg=".$_pagi_url."')\">".$_pagi_nav_anterior."</a>"; }
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='#' onClick=\"ajax_get('".$_pagi_div."','".$_pagi_enlace."','".$_pagi_enlace_var."_pagi_pg=".$_pagi_i."')\">".$_pagi_i."</a>";		
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='#' onClick=\"ajax_get('".$_pagi_div."','".$_pagi_enlace."','".$_pagi_enlace_var."_pagi_pg=".$_pagi_url."')\">".$_pagi_nav_siguiente."</a>";
...
// if(! = $DB->SelectLimit($_pagi_sql, $_pagi_cuantos, $_pagi_inicial)) die($DB->ErrorMsg());
