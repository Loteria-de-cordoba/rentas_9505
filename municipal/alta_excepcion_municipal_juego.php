...
<div id="titulo_ventana" >
  <div align="center">ALTA IMPUESTOS MUNICIPALES POR JUEGOS</div>
</div>
...
<div id="contenido">
<form name="alta_excepcion_municipal_juego" id="alta_excepcion_municipal_juego" action="#" method="post" onsubmit= "validar_alta_excepcion_mun_juego('contenido','municipal/procesar_alta_excepcion_municipal_juego.php', this); return false;" >
...
<table width="56%"  border="0" align="center"  class="detalle_tabla">
  ...
  <tr >
   ...
   <td width="73%" align="left" > <?php  armar_combo_seleccione($rs_juego,'id_juego',' ')?> </td>
  </tr>
  <tr >
