...
$titulo='IMPUESTOS MUNICIPALES POR JUEGO';
	...
	if ($salto_pagina > 270) 
							{
								...
								if ($pri=='NO'){
												...
												$pdf->Cell(50,6,'PROVINCIA',0,0,'C'); 
												$pdf->Cell(50,6,'LOCALIDAD',1,0,'C',1);	
												$pdf->Cell(50,6,'JUEGO',1,0,'C',1);	 
				...
				$pdf->SetFillColor(176,176,176);
				$pdf->SetFont('Arial','B',8);
				$pdf->Cell(50,6,'PROVINCIA',1,0,'C',1);	 	 
				$pdf->Cell(50,6,'LOCALIDAD',1,0,'C',1);
				$pdf->Cell(50,6,'JUEGO',1,0,'C',1);	 
				$pdf->Cell(30,6,'PORCENTAJE',1,1,'C',1);
}					
	    ...
	    $pdf->SetFont('Arial','',8);
		$pdf->Cell(5,5,'',0,0,'L'); 
		$pdf->Cell(50,6,$row->PROVINCIA ,0,0,'L');
		$pdf->Cell(50,6,$row->NOMBRE,0,0,'L');
		$pdf->Cell(50,6,$row->JUEGO,0,0,'L');	 
