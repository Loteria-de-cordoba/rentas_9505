...
<!--<script src="../librerias/sweetalert/sweetalert.js"></script>
 <script language="javascript" src="../librerias/sweetalert/sweetalert.js"></script> -->


<script src="js/jquery.js"></script>
<script src="js/swal.js"></script>
<script src="js/boos1.js"></script>
<script src="js/boos2.js"></script>
            ...
            <li><a class="qmparent" href="javascript:void(0)">Ingresos Brutos</a>
            	<ul>
                  <li><span class="qmtitle" >Ingresos Brutos</span></li>
                    ...
                    <li><a href="javascript:ajax_get('contenido','ingresos_brutos/importar_excel_rentas.php');" > Importar Datos de rentas </a></li>
