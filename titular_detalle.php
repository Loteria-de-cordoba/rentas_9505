...
<table width="100%" border="0" cellspacing="0">
  <tr>
    <form action="#" method="post" enctype="multipart/form-data" name="formulario" id="formulario" onSubmit="ajax_post('contenido1','titular_detalle.php',this); return false;">
		<td><table width="100%" border="0">
      	<tr>
        <td><h4>Titular
          <input name="descripcion" type="text" id="descripcion" value="<?php echo $descripcion; ?>" />
                <input type="submit" name="Submit" value="Consultar" />
                <?php  if(!isset($_POST['descripcion'])) {die();}?>
                <?php 
////////////////////////////////////////////////////////////////////////
$variables[0]=$descripcion; //array de variables bind
$variables[1]=$descripcion; //array de variables bind
...
///////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if($_pagi_result->RowCount()==0) {die ("<br>NO HAY MOVIMIENTOS "); }?>
        </h4></td>
      </tr>
    </table></td>
  </form>
